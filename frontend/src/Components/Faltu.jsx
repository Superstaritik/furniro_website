      ...
      <div className="h-20 bg-[#f1e7cf] flex items-center justify-between px-8 shadow">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <img src={gridIcon} alt="Grid" className="h-6 w-6 cursor-pointer" />
            <img src={listIcon} alt="List" className="h-6 w-6 cursor-pointer" />
          </div>

          {/* Divider + Showing Results */}
          <div className="pl-6 border-l border-gray-400">
            <h2 className="text-gray-700 font-medium">Showing 1–16 of 32 results</h2>
          </div>
        </div>

        {/* Center Section (Add Product Button) */}
        <div>
